...
- [ ] **A1 — List-row vertical padding** · _High_
...
- [ ] **A2 — Oversized empty states** · _High_
...
- [ ] **A6 — KPI/stat cards: one number in a tall box** · _Med_
...
These hit _every_ new-UI page, so they're the highest-leverage fixes.

![New dashboard](ui-audit-screenshots/new-home.png)

- [ ] **C1 — `components/homevault/HVChrome.tsx` (page header)** · _High_
...
- [ ] **C2 — `components/homevault/MetricCard.tsx`** · _High_
...
- [ ] **D1 — `pages/homevault/Today.tsx`** · _Med_
...
- [ ] **D2 — `pages/homevault/Calendar.tsx`** · _High_
...
- [ ] **D5 — `pages/homevault/Expenses.tsx` + `ExpenseRow.tsx`** · _Med_
